...
当前发布的 `0.1.5` 是商店上线前的公开预览版。Chrome 和 Edge 用户可以[下载预览版](https://github.com/wasteball/workbench/releases/tag/v0.1.5)，按照页面中的安装说明提前体验。Safari 暂未提供普通用户可安装的版本。
...
1. 在[发布页面](https://github.com/wasteball/workbench/releases/tag/v0.1.5)下载对应浏览器的 ZIP 文件。
2. 右键 ZIP 文件并选择“全部解压”。
...
`0.1.5` 是当前公开预览版。Chrome 和 Edge 已生成可安装的预览包；Safari 仍需完成商店打包、签名和真机验收。尚未迁移的旧版能力记录在[功能迁移矩阵](docs/feature-migration.md)中。
